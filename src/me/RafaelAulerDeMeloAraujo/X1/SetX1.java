...
/* 25 */       p.sendMessage("Â§cYou dont have the permission kitpvp.set1v1");
/* 26 */       return true;
/*    */     }
...
/*    */     
/* 35 */     if (args.length == 0) {
/* 36 */       p.sendMessage("Â§cUse /set1v1 <spawn/loc1/loc2>");
/* 37 */       return true;
/*    */     }
...
/*    */       }
/* 51 */       p.sendMessage("§8(§4§lTSB§f§lPVP§8) §fSpawn 1V1 Setado com Sucesso!");
/* 52 */       return true; }
...
/*    */       }
/* 65 */       p.sendMessage("§8(§4§lTSB§f§lPVP§8) §fLocal 1 Setado com Sucesso!");
/* 66 */       return true; }
...
/*    */       }
/* 79 */       p.sendMessage("§8(§4§lTSB§f§lPVP§8) §fLocal 1 Setado com Sucesso!");
/* 80 */       return true;
/*    */     }
/* 82 */     p.sendMessage("§8(§4§lTSB§f§lPVP§8) §fUse: /set1v1 <spawn/loc1/loc2>");
/*    */     
/*    */ 
/* 85 */     return false;
/*    */   }
